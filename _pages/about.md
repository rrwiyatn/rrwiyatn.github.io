...
Ex-Head of AI at [Laplaces AI](https://www.laplaces.ai/). I obtained my M.Sc. in Computer Science (Dean's Honors List) at [Mila](https://mila.quebec/)/University of Montreal/[Robotics and Embodied AI Lab (REAL)](https://montrealrobotics.ca/) under supervision of [Prof. Liam Paull](https://liampaull.ca/) and B.ASc. in Mechatronics Engineering (Dean's Honors List, with Distinction) at the University of Waterloo. I have also been fortunate to collaborate with [Dr. Anqi Xu](https://anqixu.me/) on my current and past research works at Element AI (now part of ServiceNow Research I believe), as well as [Prof. Florian Shkurti](https://www.cs.toronto.edu/~florian/) at the University of Toronto/[Robot Vision and Learning (RVL)](https://rvl.cs.toronto.edu/) lab. My research focus was to develop learning framework for solving semantic visual navigation task, where I worked on [Lifelong Topological Visual Navigation](https://montrealrobotics.ca/ltvn/). Prior to this, I spent considerable time researching the topic of adversarial attacks and defenses, where I published [PAT (ICCV'19)](https://arxiv.org/abs/1904.11042), [MJSMA (MAIS'18)](https://arxiv.org/abs/1808.07945), and a [review paper (pre-print)](https://arxiv.org/abs/1911.05268). I was also lucky to have been concretely introduced to the research world by [Prof. Jeff Orchard](https://cs.uwaterloo.ca/~jorchard/) in the [Neurocognitive Computing Lab](https://neurocog.uwaterloo.ca/) during my undergrad days. In addition, I love working on various aspects on building robots, whether it is hardware or software - whatever makes a great robot great. I also enjoy presenting my work, so please feel free to let me know if you want to learn more about it!
...
When I am not doing research, I like to play [music](https://youtube.com/playlist?list=PLyBs52SktWk7DQa6gc1tUyJfiEg3lz6ZU) (mainly acoustic and electric guitars), make [educational videos](https://www.youtube.com/playlist?list=PLyBs52SktWk5h39aCsAiweM1A4z5fVcoQ), read books, writing [blog posts](https://rrwiyatn.github.io/blog/) or [paper summaries](https://rrwiyatn.github.io/paper-summaries/), and go for a hike. I also started to explore the creative side of 3D modelling and animation, here is my coffee + donut:
